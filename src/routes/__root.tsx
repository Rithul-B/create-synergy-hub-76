...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "LearnLab" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { property: "og:title", content: "LearnLab — AI learning & content platform" },
      { name: "twitter:title", content: "LearnLab — AI learning & content platform" },
      ...
      { name: "twitter:description", content: "Chat with AI tutors, organize subjects, and instantly generate presentations, narrated audio, and video from your ideas." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/45c0b90f-a2ff-4a6c-830c-b5b360b74137" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/45c0b90f-a2ff-4a6c-830c-b5b360b74137" },
    ],
    links: [
